...
export const questions: Question[] = [
  ...
  },
  {
    ...
    alternatives: [
      "A anulação pode ser feita apenas pelo Poder Judiciário.",
      "A revogação decorre de vício de legalidade.",
      "A anulação opera efeitos ex tunc, retroagindo à origem do ato.",
      "A revogação opera efeitos ex tunc.",
      "Atos vinculados podem ser revogados por conveniência.",
    ],
    correct_answer: "2",
  },
  {
...
export const flashcards: Flashcard[] = [
  {
    ...
    review: {
      ...
      reps: 3,
      lapses: 0,
      last_reviewed_at: new Date(Date.now() - 5 * 86400000).toISOString(),
    },
  },
  {
    id: 2,
